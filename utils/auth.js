...
/**
 * Retrieves a user based on the Authorization header in the request.
 * @param {Request} req The Express request object.
 * @returns {Promise<{_id: ObjectId, email: string, password: string}
 * | null>} The user object or null if not found.
 */
...
/**
 * Retrieves a user based on the X-Token header in the request.
 * @param {Request} req The Express request object.
 * @returns {Promise<{_id: ObjectId, email: string, password:
 * string} | null>} The user object or null if not found.
 */
